...
export function TierIconUrl({ tier }) {
    ...
    const tierIconUrl = `${window.location.origin}/src/img/summonerTier/${tier}.png`;
    return (
...
export function TierMiniIconUrl({ tier }) {
    ...
    const tierIconUrl = `${window.location.origin}/src/img/miniTierIcons/${tier}.png`;
    return (
...
export function SummonerSpellIconUrl({ summonerSpeelIconId }) {
    ...
    const champIconUrl = `${window.location.origin}/src/img/summonerSpell/${summonerSpeelIconId}.png`;
    return (
        <div>
...
export function RuneIconUrl({ runeIconId }) {
    ...
    const champIconUrl = `${window.location.origin}/src/img/rune/${runeIconId}.png`;
    return (
        <>
            <img src={champIconUrl} alt="Champ Icon" height={20} width={20} />
