...
export function TierIconUrl({ tier }) {
    ...
    const tierIconUrl = `/assets/img/summonerTier/${tier}.png`;
    return (
...
export function TierMiniIconUrl({ tier }) {
    ...
    const tierIconUrl = `/assets/img/miniTierIcons/${tier}.png`;
    return (
...
export function SummonerSpellIconUrl({ summonerSpeelIconId }) {
    ...
    const champIconUrl = `/assets/img/summonerSpell/${summonerSpeelIconId}.png`;
    return (
        <div>
...
export function RuneIconUrl({ runeIconId }) {
    ...
    const champIconUrl = `/assets/img/rune/${runeIconId}.png`;
    return (
        <>
            <img src={champIconUrl} alt="Champ Icon" height={20} width={20} />
